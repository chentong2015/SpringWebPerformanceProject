...
// TODO. 优化分页查询时的性能问题
@Service
public class WebPerfPageableService {
    ...
    private WebPerfPageableService(EntityManager entityManager) {
        this.entityManager = entityManager;
    }

     // 使用JPA EntityManager并发执行数据查询和Count统计
     public Page<UserEntity> findAllUsersPerf(Pageable pageable) throws Exception {
         EntityManagerFactory emf = entityManager.getEntityManagerFactory();

         // 异步执行Count统计: 统计结果不会被Lazy加载，保证使用安全
